...
public class popup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Data di TokoSebelah");
        setBackground(new java.awt.Color(255, 143, 102));
        ...
        jLabel8.setFont(new java.awt.Font("Google Sans", 1, 18)); // NOI18N
    ...
    String sql="SELECT * FROM `produk` NATURAL JOIN `order` WHERE id_produk=?";
    pst=koneksi.prepareStatement(sql);
